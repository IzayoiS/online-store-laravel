    ...
    <section class="store-review">
        ...
        <div class="row">
            ...
            <ul class="list-unstyled">
                <li class="media">
                <img
                    src="/images/icons-testimonial-1.svg"
                ...
                <li class="media">
                <img
                    src="/images/icons-testimonial-2.svg"
                    class="mr-3 rounded-circle"
                    alt=""
                />
                <div class="media-body">
                ...
                <li class="media">
                <img
                    src="/images/icons-testimonial-3.svg"
                    class="mr-3 rounded-circle"
                    alt=""
                />
                <div class="media-body">
...
<script>
    ...
    data: {
        ...
        {
            id: 1,
            url: "/images/product-details-1.svg",
        },
        {
            id: 2,
            url: "/images/product-details-2.svg",
        },
        {
            id: 3,
            url: "/images/product-details-3.svg",
        },
        {
            id: 4,
            url: "/images/product-details-4.svg",
        },
        ],
    },
    methods: {
