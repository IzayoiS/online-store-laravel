                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="provinces_id" id="provinces_id" class="form-control"
                                                    ...
                                                    <option disabled :value="null">Select Province</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="regencies_id" id="regencies_id" class="form-control"
                                                    v-model="regencies_id" :disabled="!provinces_id || !regencies">

                                                    <option :value="null" disabled>
                                                        @{{ !provinces_id ? 'Please Select Province First' : 'Please Select Regency' }}
                                                    </option>
