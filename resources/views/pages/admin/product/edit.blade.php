                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" style="resize: none; height: 130px" class="form-control">{!! $item->description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
@push('addon-script')
    ...
    if (priceInput.value) {
        ...
        priceInput.value = new Intl.NumberFormat().format(initialValue);
    }
